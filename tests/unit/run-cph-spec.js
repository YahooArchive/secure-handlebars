...
(function () {
    ...
    describe("context-parser-handlebars test suite", function() {
        ...
        it("context-parser-handlebars#basic branch AST test", function() {
            ...
            expect(ast.program[0].content.program[1].type).to.equal('html');
            ...
            expect(ast.program[1].type).to.equal('html');
        ...
        it("context-parser-handlebars#basic branch with {{expression}} AST test", function() {
            ...
            expect(ast.program[0].content.program[3].type).to.equal('html');
        ...
        it("context-parser-handlebars#basic branch with inverse AST test", function() {
            ...
            expect(ast.program[0].content.inverse[1].type).to.equal('html');
        ...
        it("context-parser-handlebars#nested branch AST test", function() {
            ...
            expect(ast.program[0].content.program[2].content.program[1].type).to.equal('html');
            ...
            expect(ast.program[0].content.program[2].content.inverse[1].type).to.equal('html');
            ...
            expect(ast.program[0].content.inverse[2].content.program[1].type).to.equal('html');
            ...
            expect(ast.program[0].content.inverse[2].content.inverse[1].type).to.equal('html');
            ...
            expect(ast.program[0].content.inverse[3].type).to.equal('html');
        ...
        it("context-parser-handlebars#parallel branch AST test", function() {
            ...
            expect(ast.program[0].content.program[4].content.program[1].type).to.equal('html');
            ...
            expect(ast.program[0].content.program[4].content.inverse[1].type).to.equal('html');
            ...
            expect(ast.program[0].content.program[5].type).to.equal('html');
